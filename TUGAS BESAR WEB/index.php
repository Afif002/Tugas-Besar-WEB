...
<head>
    ...
    <style>
        ...
        * {
        ...
        header img {
            max-width: 100px; /* Ukuran logo kecil */
            height: auto;
            margin-bottom: 10px;
        }
        ...
        border-radius: 8px;
        margin-bottom: 15px;
        transition: transform 0.5s ease; /* Menambahkan transisi untuk animasi */
        }
        ...
        .vehicle-item .btn-rent:hover {
            ...
            transform: translateY(-5px); /* Tombol naik sedikit saat di-hover */
        }
    ...
    <section class="hero">
        ...
        <div class="vehicle-list">
            <div class="vehicle-item">
                ...
                <button class="btn-rent" onclick="location.href='login.php';">Sewa Sekarang</button>
            </div>
